        ...
        <div class="col-12">
            <div class="db-card">
                <div class="db-card-header border-none">
                    <h3 class="db-card-title">{{ __('reports.customer_report') }}</h3>
                    ...
                    <div class="p-5 mb-8">
                        <div class="row">
                            <div class="col-4 sm:col-4">
                                <label class="db-field-title">{{ __('levels.customer') }}</label>
                ...
                <div class="db-table-responsive" id="printablediv">
                    <table class="db-table table stripe" id="maintable"
                        data-url="{{ route('admin.customer-report.index') }}">
                        <thead class="db-table-head">
                            <tr class="db-table-head-tr">
                                ...
                                <th class="db-table-head-th">{{ __('order.total_order') }}</th>
                                <th class="db-table-head-th">{{ __('levels.credit') }}</th>
                            </tr>
                        </thead>
                    </table>
                </div>
