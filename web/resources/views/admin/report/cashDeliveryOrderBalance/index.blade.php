        ...
        <div class="col-12">
            <div class="db-card">
                <div class="db-card-header border-none">
                    <h3 class="db-card-title">{{ __('reports.cash_on_delivery_report') }}</h3>
                ...
                <div class="db-table-responsive" id="printablediv">
                    <table class="db-table table stripe" id="maintable" data-url="{{ route('admin.cash-on-delivery-order-balance-report.index') }}">
                        <thead class="db-table-head">
                            <tr class="db-table-head-tr">
                                <th class="db-table-head-th">{{ __('levels.name') }}</th>
                                <th class="db-table-head-th">{{ __('levels.phone') }}</th>
                                <th class="db-table-head-th">{{ __('order.delivery_commision') }}</th>
                                <th class="db-table-head-th">{{ __('order.cod_amount') }}</th>
                            </tr>
                        </thead>
                    </table>
                </div>
