        ...
        <div class="col-12">
            <div class="db-card">
                <div class="db-card-header border-none">
                    <h3 class="db-card-title">{{ __('reports.reservation_report') }}</h3>
                    ...
                    <div class="p-5 mb-8">
                        <div class="row">
                            ...
                            <div class="col-4 sm:col-4">
                                <label class="db-field-title">{{ __('levels.select_restaurant') }}</label>
                            ...
                            <div class="col-12">
                                <div class="flex flex-wrap gap-3 mt-4 input-group-append">
                                    <button class="db-btn py-2 text-white bg-primary" id="date-search">
                ...
                <div class="db-table-responsive" id="printablediv">
                    <table class="db-table table stripe" id="maintable" data-url="{{ route('admin.reservation-report.index') }}">
                        <thead class="db-table-head">
                            <tr class="db-table-head-tr">
                                ...
                                <th class="db-table-head-th">{{ __('levels.slot') }}</th>
                                <th class="db-table-head-th">{{ __('levels.guest') }}</th>
