...
function variationItemDesign() {
    ...
    markup += '<tr class="db-table-body-tr border-none">';
        markup += '<td class="db-table-body-td">';
            markup += '<input type="text" name="variation['+menu_item_variation_count+'][name]" placeholder="Name" name="name" class="db-field-control form-control-sm">';
        markup +='</td>';
        markup +='<td class="db-table-body-td">';
            markup += '<input type="text" step=".01" name="variation['+menu_item_variation_count+'][price]" placeholder="Price" class="db-field-control form-control-sm change-productprice">';
        markup += '</td>';
        markup +='<td class="db-table-body-td">';
        markup +='<input type="text" step=".01" name="variation['+menu_item_variation_count+'][discount_price]" placeholder="Discount Price" class="db-field-control form-control-sm change-productdiscountprice">';
        markup +='</td>';
        markup +='<td class="db-table-body-td">';
...
function optionItemDesign() {
    ...
    markup += '<tr class="db-table-body-tr border-none">';
        markup += '<td class="db-table-body-td">';
            markup += '<input type="text" name="option['+menu_item_option_count+'][name]" placeholder="Name" class="db-field-control form-control-sm">';
        markup +='</td>';
        markup +='<td class="db-table-body-td">';
            markup += '<input type="text" step=".01" name="option['+menu_item_option_count+'][price]" placeholder="Price" class="db-field-control form-control-sm change-productprice">';
        markup += '</td>';
        markup +='<td class="db-table-body-td">';
            markup += '<button class="db-table-action delete removeBtn"> '
                markup += '<i class="fa-solid fa-trash-can"></i>';
